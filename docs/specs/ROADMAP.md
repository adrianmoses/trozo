...
| 001 | Seed v0 + chunk service (30 seed items; `POST /v1/chunk` returns valid JSON; eval runner prints chunk recall and calque rate) | in-progress | [spec](001-seed-chunk-service/spec.md)   |
