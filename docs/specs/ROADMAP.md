...
| 002 | Translator UI (input bar, full translation, watch-out box, chunk cards, notes, copy; `fast` confidence from seed)             | in-progress | [spec](002-translator-ui/spec.md)        |
